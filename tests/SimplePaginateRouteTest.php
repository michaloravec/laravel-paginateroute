...
class SimplePaginateRouteTest extends TestCase
{
    /**
     * @var string
     */
    ...
    public function it_returns_a_previous_page_url()
    {
        ...
        $response = $this->callRoute('/3');

        $this->assertTrue($response['hasPrevious']);

        $this->assertEquals($this->hostName.'/dummies/2', $response['previousPageUrl']);
    }
    ...
    public function it_returns_a_next_page_url()
    {
        ...
        $this->assertEquals($this->hostName.'/dummies/2', $response['nextPageUrl']);
    }
    ...
    public function it_returns_all_urls()
    {
        ...
        $allUrls = [
            ...
            $this->hostName.'/dummies/2',
            $this->hostName.'/dummies/3',
            $this->hostName.'/dummies/4',
        ];
        ...
        $allUrlsFull[0] = $this->hostName.'/dummies/1';
    ...
    public function it_renders_an_html_list()
    {
        ...
        $expectedForFirstPage = '<ul><li class="active"><a href="http://localhost/dummies">1</a></li><li><a href="http://localhost/dummies/2">2</a></li><li><a href="http://localhost/dummies/3">3</a></li><li><a href="http://localhost/dummies/4">4</a></li></ul>';

        $this->assertEquals($expectedForFirstPage, $firstPage['list']);

        $secondPage = $this->callRoute('/2');

        $expectedForSecondPage = '<ul><li><a href="http://localhost/dummies">1</a></li><li class="active"><a href="http://localhost/dummies/2">2</a></li><li><a href="http://localhost/dummies/3">3</a></li><li><a href="http://localhost/dummies/4">4</a></li></ul>';

        $this->assertEquals($expectedForSecondPage, $secondPage['list']);

        $expectedForFirstPageWithClass = '<ul class="pagination"><li class="active"><a href="http://localhost/dummies">1</a></li><li><a href="http://localhost/dummies/2">2</a></li><li><a href="http://localhost/dummies/3">3</a></li><li><a href="http://localhost/dummies/4">4</a></li></ul>';
    }
    ...
    public function it_adds_query_string_to_page_urls()
    {
        ...
        $response = $this->callRoute('/2', ['test' => 123]);

        $this->assertTrue($response['hasNext']);

        $this->assertEquals($this->hostName.'/dummies/3?test=123', $response['nextPageUrl']);
        ...
        $this->assertEquals($this->hostName.'/dummies/1?test=123', $fullPreviousUrl);
    }
}
